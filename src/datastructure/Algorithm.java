...
public class Algorithm {
	...
	public static void main(String[] args) {
		...
		if(choice == 1) {
			...
			switch(n1) {
			case 1:
                                 new LinearSearch(in.sort_input()).get_output();
				break;
			case 2:
                            new BinarySearch(in.sort_input()).get_output();
				break;
			case 3:
				...
				break;
			case 4:
                             new InsertionSort(in.sort_input()).result();
				break;
			case 5:
                            new SelectionSort(in.sort_input()).result();
				break;
			case 6:
                            new MergeSort(in.sort_input()).result();
				break;
			case 7:
                             new QuickSort(in.sort_input()).result();
				break;
			case 8:
                            new CountingSort(in.sort_input()).result();
				break;
			case 9:
                            new RadixSort(in.sort_input()).result();
				break;
			case 10:
                             new BucketSort(in.sort_input()).result();
				break;
			case 11:
                            new ShellSort(in.sort_input()).result();
				break;
			case 12:
			...
			case 14:
				...
				break;
			case 15:
                            new HeapSort(in.sort_input()).result();
				break;
			case 16:
			...
			case 1:
                    ...
                    case 9:
                        ...
                        break;
			default:
                            System.out.println("Please Select Accurate Number\n");
				break;
		}
